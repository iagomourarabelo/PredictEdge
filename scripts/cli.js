...
const contractABI = require("../artifacts/contracts/Predictedge.sol/Predictedge.json").abi;

program
    .name("predictedge-cli")
    .description("CLI tool for Predictedge smart contract")
    .version("1.0.0");
